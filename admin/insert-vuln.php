...
if (!isset($_POST['name']) or !isset($_POST['slug']) or !isset($_POST['description']) or !isset($_POST['analysis']) or
    ...
    !isset($_POST['hidden']) or !isset($_POST['impact']) or !isset($_POST['probability'])) {
...
execPrepare($mysqli,"INSERT INTO vulns (id,name,slug,description,analysis,remediation,synopsis,cvssv2base,cvssv2vector,cvssv3base,cvssv3vector,hidden,impact,probability) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?);", array("issssssssssiii", $_POST['id'], $_POST['name'],$_POST['slug'],$_POST['description'],$_POST['analysis'],$_POST['remediation'],$_POST['synopsis'],$_POST['CVSSv2Base'],$_POST['CVSSv2Vector'],$_POST['CVSSv3Base'],$_POST['CVSSv3Vector'], $_POST['hidden'], $_POST['impact'], $_POST['probability']));
softRedirect('/admin/vulndb/');

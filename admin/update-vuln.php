...
execPrepare($mysqli,"UPDATE vulns SET name = ?, slug = ?, description = ?, analysis = ?, remediation = ?, synopsis = ?, cvssv2base = ?, cvssv2vector = ?, cvssv3base = ?, cvssv3vector = ?, hidden = ?, impact = ?, probability = ? WHERE id = ?;", array("ssssssssssiiii", $_POST['name'],$_POST['slug'],$_POST['description'],$_POST['analysis'],$_POST['remediation'],$_POST['synopsis'],$_POST['CVSSv2Base'],$_POST['CVSSv2Vector'],$_POST['CVSSv3Base'],$_POST['CVSSv3Vector'], $_POST['hidden'], $_POST['impact'], $_POST['probability'], $_POST['id']));
softRedirect('/admin/vulndb/');
